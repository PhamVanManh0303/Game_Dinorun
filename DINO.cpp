...
void ds(int jump=0) {
    ...
    gotoxy(5,27-t);
    printf("                 ");gotoxy(5,28-t);
    printf("         ЬЫЯЫЫЫЫЬ");gotoxy(5,29-t);
    printf("         ЫЫЫЫЫЫЫЫ");gotoxy(5,30-t);
    printf("         ЫЫЫЫЫЯЯЯ");gotoxy(5,31-t);
    printf(" Ы      ЬЫЫЫЫЯЯЯ ");gotoxy(5,32-t);
    printf(" ЫЫЬ  ЬЫЫЫЫЫЫЬЬЬ ");gotoxy(5,33-t);
    printf(" ЯЫЫЫЫЫЫЫЫЫЫЫ  Я ");gotoxy(5,34-t);
    printf("   ЯЫЫЫЫЫЫЫЯ     ");gotoxy(5,35-t);
    if(jump==1 || jump==2){
    printf("    ЫЫЯ ЯЫ       ");gotoxy(5,36-t);
    printf("    ЫЬ   ЫЬ      ");
    }
	else if(a==1){
    printf("    ЯЫЫЯ  ЯЯЯ    ");gotoxy(5,36-t);
    printf("      ЫЬ         ");
    a=2;
    }
    else if(a==2){
    printf("     ЯЫЬ ЯЫ      ");gotoxy(5,36-t);
    printf("          ЫЬ     ");
    a=1;
    }
    gotoxy(0,37-t);
...
void how_to_play(){
	...
	SetColor(6);
	gotoxy(x1,y+5);printf("You use the SPACEbar");
	gotoxy(x1-1.25,y+7);printf("To control the DINOSAUR");
